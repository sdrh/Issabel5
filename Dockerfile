...
MAINTAINER Steve Rodríguez Hageman <srodriguez@ingeniarcomunicaciones.com>
...
RUN curl -LOs "https://sourceforge.net/projects/issabelpbx/files/Issabel 5/issabel5-netinstall.sh" && chmod 777 issabel4-asterisk13-netinstall.sh && ln -s issabel4-asterisk13-netinstall.sh install.sh
##RUN curl -LOs "https://cfhcable.dl.sourceforge.net/project/issabelpbx/Issabel%205/issabel5-netinstall.sh" && chmod 777 issabel4-asterisk13-netinstall.sh && ln -s issabel4-asterisk13-netinstall.sh install.sh
