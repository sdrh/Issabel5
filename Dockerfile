...
LABEL com.ingeniarcomunicaciones.image.authors="srodriguez@ingeniarcomunicaciones.com"
LABEL "com.ingeniarcomunicaciones.vendor"="ingeniar Comunicaciones"
LABEL version="1.0"
LABEL description="Issabel 5 from netinstall"
